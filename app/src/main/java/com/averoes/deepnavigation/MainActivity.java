...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOpenDetail = findViewById(R.id.openDetail);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.openDetail){
            Intent detailIntent = new Intent(MainActivity.this, DetailActivity.class);
            detailIntent.putExtra(DetailActivity.EXTRA_TITLE, "Good News");
            detailIntent.putExtra(DetailActivity.EXTRA_MESSAGE, "Now you can learn programming free");
