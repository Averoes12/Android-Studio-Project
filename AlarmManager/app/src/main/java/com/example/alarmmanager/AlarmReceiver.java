...
public class AlarmReceiver extends BroadcastReceiver {
    public static final String TYPE_DATE_REMINDER = "OneTimeAlarm";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String title = type.equalsIgnoreCase(TYPE_DATE_REMINDER) ? TYPE_DATE_REMINDER : TYPE_REPEATING;
        int notifId = type.equalsIgnoreCase(TYPE_DATE_REMINDER) ? ID_ONETIME : ID_REPEATING;
    ...
    public void cancelAlarm(Context context, String type) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(context, AlarmReceiver.class);
        int requestCode = type.equalsIgnoreCase(TYPE_DATE_REMINDER) ? ID_ONETIME : ID_REPEATING;
